...
# ==========================
par(mfrow = c(2,3))
boxplot(airport$V3, main = "Scheduled departures")
boxplot(airport$V4, main = "Performed departures")
boxplot(airport$V5, main = "Enplaned passengers")
boxplot(airport$V6, main = "Revenue tons of freight")
boxplot(airport$V7, main = "Revenue tons of mail")
...
# Boxplot: медиана ближе к нижней границе ящика, верхний ус длиннее нижнего, много выбросов сверху.
